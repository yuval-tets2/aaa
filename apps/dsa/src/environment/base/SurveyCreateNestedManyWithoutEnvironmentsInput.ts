...
@InputType()
class SurveyCreateNestedManyWithoutEnvironmentsInput {
...
export { SurveyCreateNestedManyWithoutEnvironmentsInput as SurveyCreateNestedManyWithoutEnvironmentsInput };
