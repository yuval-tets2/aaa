...
@InputType()
class WebhookCreateNestedManyWithoutEnvironmentsInput {
...
export { WebhookCreateNestedManyWithoutEnvironmentsInput as WebhookCreateNestedManyWithoutEnvironmentsInput };
