...
@InputType()
class AttributeClassCreateNestedManyWithoutEnvironmentsInput {
...
export { AttributeClassCreateNestedManyWithoutEnvironmentsInput as AttributeClassCreateNestedManyWithoutEnvironmentsInput };
