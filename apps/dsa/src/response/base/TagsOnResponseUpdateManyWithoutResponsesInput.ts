...
@InputType()
class TagsOnResponseUpdateManyWithoutResponsesInput {
...
export { TagsOnResponseUpdateManyWithoutResponsesInput as TagsOnResponseUpdateManyWithoutResponsesInput };
