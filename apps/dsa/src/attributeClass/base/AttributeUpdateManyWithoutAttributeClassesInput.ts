...
@InputType()
class AttributeUpdateManyWithoutAttributeClassesInput {
...
export { AttributeUpdateManyWithoutAttributeClassesInput as AttributeUpdateManyWithoutAttributeClassesInput };
