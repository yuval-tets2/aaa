...
@InputType()
class AttributeCreateNestedManyWithoutAttributeClassesInput {
...
export { AttributeCreateNestedManyWithoutAttributeClassesInput as AttributeCreateNestedManyWithoutAttributeClassesInput };
